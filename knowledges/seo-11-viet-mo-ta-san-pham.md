...
- **Không dùng heading kiểu nhãn nội bộ/học thuật**: "Định nghĩa sản phẩm", "Giới thiệu", "Tổng quan", "Mô tả" nghe như tiêu đề chương giáo trình, không phải câu hỏi khách hàng thật sự có trong đầu khi đọc trang sản phẩm. Heading phải nêu đúng nội dung cụ thể bên dưới theo bảng H2 ở mục này (VD "Tính năng nổi bật" thay vì "Giới thiệu", "Khả năng tương thích" thay vì "Tương thích sản phẩm"). Tương tự, không đánh số heading kiểu "Block 1", "Phần 2" vì đó là nhãn quy trình nội bộ, không phải nội dung khách đọc.
